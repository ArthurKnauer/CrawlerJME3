...
void main()
{
    ...
    vec3 flux = m_FluxScale * (texture2D(m_ColorMap, texCoord)).xyz / m_RSMArea;

    gl_FragData[0] = flux.r * sh;
    gl_FragData[1] = flux.g * sh;
    gl_FragData[2] = flux.b * sh;
}