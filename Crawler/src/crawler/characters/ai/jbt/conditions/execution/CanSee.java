...
// ******************************************************* 
package crawler.characters.ai.jbt.conditions.execution;

/** ExecutionCondition class created from MMPM condition CanSee. */
public class CanSee extends
	...
	/**
	 * Constructor. Constructs an instance of CanSee that is able to run a
	 * crawler.characters.ai.jbt.conditions.model.CanSee.
	 * 
	 * @param target
	 ...
	 *            retrieved from.
	 */
	public CanSee(crawler.characters.ai.jbt.conditions.model.CanSee modelTask,
