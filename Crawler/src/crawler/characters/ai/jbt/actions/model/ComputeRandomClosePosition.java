...
public class ComputeRandomClosePosition extends
	...
	/**
	 * Returns a
	 * crawler.characters.ai.jbt.actions.execution.ComputeRandomClosePosition
	 * task that is able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new crawler.characters.ai.jbt.actions.execution.ComputeRandomClosePosition(
				this, executor, parent, this.initialPosition,
