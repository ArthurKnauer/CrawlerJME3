...
/** ModelAction class created from MMPM action Follow. */
public class Follow extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of Follow.
	 * 
	 * @param target
	 ...
	 *            retrieved from.
	 */
	public Follow(jbt.model.core.ModelTask guard, java.lang.String target,
	...
	/**
	 * Returns a crawler.characters.ai.jbt.actions.execution.Follow task that is
	 * able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new crawler.characters.ai.jbt.actions.execution.Follow(this,
