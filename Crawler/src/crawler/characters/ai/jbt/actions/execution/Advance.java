...
// ******************************************************* 
package crawler.characters.ai.jbt.actions.execution;

/** ExecutionAction class created from MMPM action Advance. */
public class Advance extends jbt.execution.task.leaf.action.ExecutionAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of Advance that is able to run a
	 * crawler.characters.ai.jbt.actions.model.Advance.
	 * 
	 * @param target
	 ...
	 *            retrieved from.
	 */
	public Advance(crawler.characters.ai.jbt.actions.model.Advance modelTask,
