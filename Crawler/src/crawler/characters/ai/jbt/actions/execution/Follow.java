...
/** ExecutionAction class created from MMPM action Follow. */
public class Follow extends jbt.execution.task.leaf.action.ExecutionAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of Follow that is able to run a
	 * crawler.characters.ai.jbt.actions.model.Follow.
	 * 
	 * @param target
	 ...
	 *            retrieved from.
	 */
	public Follow(crawler.characters.ai.jbt.actions.model.Follow modelTask,
